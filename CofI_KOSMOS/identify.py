...
__all__ = ['loadlinelist', 'loadarctemplate', 'identify_widget',
...
def identify_widget(arcspec, silent=False):
    ...
    linename =     widgets.Dropdown(
        options=['6143.06', '6334.43', '6402.25', '6506.53', '6678.28', '6717.04', '6929.47', '7032.41', '7245.17', '7438.90', '8300.36', '8377.61', '8495.36', '8654.38', '8780.62'],
